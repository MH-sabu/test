...
SECRET_KEY = '-0qn18bgm3lyylo9wfo(!@(b53zp$-_3p!)mjzsw=8g*fm41&$'
...
DEFAULT_COUNTRY = os.environ.get("DEFAULT_COUNTRY", "BD")
DEFAULT_CURRENCY = os.environ.get("DEFAULT_CURRENCY", "BDT")
